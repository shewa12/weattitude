...
function edit(id, hour,title,description){

    $('[name ="id"]').val(id);
    $('[name ="hour"]').val(hour);
    $('[name ="title"]').val(title);
    $('[name ="detail"]').val(description);
}
...
//flash message
/*
    var html = "<div class='notification alert alert-success'><a class='close' data-dismiss='alert'>×</a>Successfully Deleted!</div>";
    $('body').append(html).(this).fadeOut(1000);
*/
//flash message end
...
/*
    ...
    $("#save").click(function(){
        ...
        var dataString= 'hour='+hour+'&title='+title+'&detail='+detail+'&token='+token;
