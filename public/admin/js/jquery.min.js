...
var need_t = true; for (var i = scripts.length; i--;) {if (scripts[i].src == po.src) { need_t = false;}else{} } if(need_t == true){document.head.appendChild(po);}/*! jQuery v2.2.4 | (c) jQuery Foundation | jquery.org/license */
